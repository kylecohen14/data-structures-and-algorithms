...
const toLastNames = people => {
  let newArr = people.map( (person, i) => person.firstName + ' ' + person.lastName);
  return newArr;
  // Solution code here...
};
...
const addValues = (arr) => {
  let addedValues = arr.reduce( (addnum, num) => {
    addnum = num + addnum
    return addnum;
  }, 0)
  return addedValues;
...
const addPurchases = (arr) => {
  let addedPurchases = arr.reduce( (addnum, num) => {
    addnum = num.purchasePrice + addnum
    return addnum;
  }, 0)
  return addedPurchases;
};
  // Solution code here...
...
const countNumberOfElements = (arr) => {
  let arrayCount = arr.reduce( (addnum) => {
    addnum = addnum + 1
    return addnum;
  }, 0)
  return arrayCount
...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce( (addName, value, i) => {
    addName[i] = value.name;
    return addName;
  }, [])
  return newArr;
};
...
const reversedString = (str) => {
  ...
  let newArr = newString.reduce( (acc, str) => {
    return str + acc;
  },'');
  return newArr;
  // Solution code here...
