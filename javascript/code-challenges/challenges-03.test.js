...
const typeNum = (arr) => {
  const newArr = arr.filter((num) => Number.isInteger(num));
  return newArr;
  // Solution code here...
};
...
const containsAnd = (arr) => {
  const newArr = arr.filter((element) => element.includes('and'));
  return newArr;
  // Solution code here...
};
...
const oddValues = (arr) => {
  const newArr = arr.filter((nums) => nums%2);
  return newArr;
  // Solution code here...
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const newArr = arr.filter((nums) => !forbiddenValues.includes(nums));
  return newArr;
};
